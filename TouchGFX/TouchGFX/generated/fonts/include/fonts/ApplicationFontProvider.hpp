...
{
    static const touchgfx::FontId HEADLINE = 0;     // RobotoCondensed_Regular_30_4bpp
    static const touchgfx::FontId NORMAL = 1;       // Asap_Regular_14_4bpp
    static const touchgfx::FontId BUTTON_STYLE = 2; // RobotoCondensed_Regular_18_4bpp
